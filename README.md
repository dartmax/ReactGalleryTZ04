...
- Статична — Кожена змінна в статично типізований мові належить до певного типу, який можна визначити без запуску коду.
...
var - одна на все ітерації циклу і видно навіть після циклу. Обробляються на початку виконання функції
...
- Array.from () створює нову реалізацію Array з массівоподобного або ітеріруемого об'єкта.
...
execute(f); // що буде у консолі і чому
