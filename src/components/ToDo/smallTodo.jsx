...
function SmallTodo() {
  ...
  const removeTask = (id) => { //фильтруем список задач по текущей ID и добавляем его обратно в стейт
    ...
    setTodos([...todos.filter((todo) => todo.id !== id)]) // если тодо id не равен пришедшему id тогда возвращаем все элементы массива, если условие не выполняется тогда текущий элемент мы не возвращаем
  }
