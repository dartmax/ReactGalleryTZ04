 ...
 */
const liqpay = function(public_key, private_key) {
...
const encrypt = function(params) {
  let data = JSON.stringify(_.extend({}, params, {public_key: this.public_key}));
  return {
...
liqpay.prototype.api = function(method, params, callback) {
  ...
  params = params || {};
  let data = JSON.stringify(_.extend({public_key: this.public_key}, params));
